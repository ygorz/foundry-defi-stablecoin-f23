...
contract DSCEngine is ReentrancyGuard {
        ...
        external
    {
        ...
        // redeem collateral reverts if health factor is broken
    }
    ...
    function burnDSC(uint256 amountToBurn) public moreThanZero(amountToBurn) {
        ...
        _revertIfHealthFactorIsBroken(msg.sender); // as a back up, needed?
    }

    // if someone is almost undercollateralized, we will pay you to liquidate them!
    /**
     * @param collateral The ERC20 collateral address to liquidate from the user.
     * @param user The user  who has broken the health factor. Their _healhFactor should be below MIN_HEALTH_FACTOR.
     * @param debtToCover The amount of DSC you want to burn to improve the users health factor.
     * @notice You can partially liquidate a user.
     * @notice You will get a liquidation bonus for taking the users funds.
     * @notice This function working assumes the protocol will be roughly 200% overcollateralized to work.
     ...
     * For example, if the price fo the collateral plummeted before anyone could be liquidated.
     *
    ...
    function getUsdValue(address token, uint256 amount) public view returns (uint256) {
        ...
        return
        // example: 2000e8 * 1e10 * 15e18 / 1e18
    ...
    function getMinimumHealthFactorNeeded() external pure returns (uint256) {
